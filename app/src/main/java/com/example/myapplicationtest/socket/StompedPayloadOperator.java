...
public class StompedPayloadOperator implements Runnable {
    private StompedFrame payload;
    private WebSocketConnectorAddHeaders connector;

    public StompedPayloadOperator(StompedFrame payload, WebSocketConnectorAddHeaders connector){
    ...
    public void run(){
        ...
        try {
            ...
            Method method = WebSocketConnectorAddHeaders.class.getDeclaredMethod("write", payload.build().getClass());
