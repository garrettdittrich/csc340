...
public class GpsService extends Service {
    ...
    */
    ...
    public void subscribe(){
        ...
        client.subscribe("/topic/incoming", new StompedListener() {
            @Override
            public void onNotify(final StompedFrame frame) {
                Log.d("GpsService", "Received Gps update in GpsService" + mLastLocation.getLongitude());
    ...
    public void onCreate() {
        ...
        subscribe();
       Log.d("GpsService", "New Gps service initialized");
    }
